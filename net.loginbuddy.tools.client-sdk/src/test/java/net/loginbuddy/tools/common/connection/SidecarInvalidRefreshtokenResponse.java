...
public class SidecarInvalidRefreshtokenResponse extends BasicHttpResponse {

    public SidecarInvalidRefreshtokenResponse(StatusLine statusline) {
        super(statusline);
    }
    ...
    public HttpEntity getEntity() {
        ...
        try {
            bhe.setContent(new FileInputStream("src/test/resources/testInvalidRefreshTokenResponse.json"));
            return bhe;
